...
urlpatterns = [
    ...
    url(r'^hamiar_prof/$', madadju.views.show_hamiar_profile),
    url(r'^niaz_haye_madadju/$', madadju.views.show_niaz_haye_madadju),
    url(r'^password_change/$', madadju.views.edit_profile),
